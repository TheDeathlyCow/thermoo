...
public class ThermooPolymerPatch implements DependentServerModInitializer {
    ...
    private static void polymerizeArgumentTypes() {
        RegistrySyncUtils.setServerEntry(Registries.COMMAND_ARGUMENT_TYPE, Thermoo.HEATING_MODE_ARG_SERIALIZER);
        RegistrySyncUtils.setServerEntry(Registries.COMMAND_ARGUMENT_TYPE, Thermoo.TEMPERATURE_UNIT_ARG_SERIALIZER);
    }
