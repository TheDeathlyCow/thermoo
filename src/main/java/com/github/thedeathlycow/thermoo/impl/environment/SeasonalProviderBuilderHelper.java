...
public class SeasonalProviderBuilderHelper {
    ...
    private final Map<ThermooSeason, EnvironmentProvider> seasons = new EnumMap<>(ThermooSeason.class);
    ...
    public Map<ThermooSeason, EnvironmentProvider> getSeasons() {
        return seasons;
    }
    ...
    public void setSeasonProvider(@NotNull ThermooSeason season, @NotNull EnvironmentProvider provider) {
        Objects.requireNonNull(season);
